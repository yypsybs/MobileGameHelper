...
class AlasGUI(Frame):
    ...
    def show(self) -> None:
        ...
        with use_scope("content"):
            ...
            put_markdown(
                """
                This software is secondary development software based on Alas, thanks to the original authors for their selfless dedication.
                此软件基于Alas进行二次开发，感谢原作者们的无私奉献。
                This software is a free open source software, if you paid from any channel, please refund.
                此软件是一款免费开源软件，如果你在任何渠道付费购买，请退款。
                Project repository of Alas Alas项目地址：`https://github.com/LmeSzinc/AzurLaneAutoScript`
                Project repository of this project 此项目地址：`https://github.com/LmeSzinc/AzurLaneAutoScript`
            """
            ).style("text-align: center")
